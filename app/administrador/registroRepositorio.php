                ...
                <div class="modal-body">  
                     ...
                     <form method="post" action="uploadRepositorio.php" id="insert_form" enctype="multipart/form-data" onsubmit="return validar();">
                            <div class="form-row">
                                ...
                                <select name="alumnoRepositorio" id="alumnoRepositorio" class="form-control alumno">
...
<script>
    function validar() {
        ...
        {  
            ...
            Toast.fire({
                type: 'error',
                title: 'Manual Tecnico Requerido'
            });
            return false;
        }else if($('#fsistema').val() == ''){
            const Toast = Swal.mixin({
            ...
            Toast.fire({
                type: 'error',
                title: 'Manual de Usuario Requerido'
            });
            return false;
