...
<head>
    ...
    <title>Alumnos | RepositorioUTCGG</title>
    <!-- SCRIPTS -->
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                            ...
                            <input type="text" name="alumno" id="alumno" class="form-control" placeholder="Nombre(s)"/>  
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="cuatri" id="cuatri" class="form-control cuatri">
                                        <option value="">Selecciona una Cuatrimestre</option>
                                        <?php
