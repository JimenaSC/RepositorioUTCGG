...
<head>
    ...
    <title>Docentes | RepositorioUTCGG</title>
    <!-- SCRIPTS -->
...
<body>
    ...
    <div class="row" id="body-row">
        ...
        <div class="col mt-5">
            ...
            <!-- CARD-->
            <div class="card">
                <h4 class="card-header text-center">Registro de Docentes</h4>
                <div class="card-body">
                    <div class="row">
    ...
    <script src="js/mainDocentes.js"></script>
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                            ...
                            <input type="text" name="docente" id="docente" class="form-control docente" placeholder="Nombre(s)"/>  
                            <div class="form-row">
